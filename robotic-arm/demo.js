...
arm.setAngles([0, 0, 0]);
console.log('Initial end effector:', arm.getEndEffector());
...
for(const t of targets){
  ...
  console.log('Final angles (deg):', arm.angles.map(a => (a*180/Math.PI).toFixed(2)));
  console.log('Final end effector:', arm.getEndEffector());
}
